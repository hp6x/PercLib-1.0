...
function initLibrary()
    ...
    function library:Load(opts)
        ...
        local topbar = utility.create("Frame", {
            ZIndex = 2,
            Size = UDim2.new(0, sizeX, 0, 40),
            Position = utility.get_center(sizeX, sizeY + 14),
            BorderSizePixel = 0,
            BackgroundColor3 = Color3.fromRGB(18, 18, 18),
            Parent = gui
        })

        -- Rounded corners for topbar
        ...
        -- Rainbow gradient title (centered)
        ...
        -- Rainbow gradient effect (Red > Purple > Black)
        ...
        spawn(function()
            ...
            while true do
                offset = offset + 0.5
                if offset >= 360 then offset = 0 end
                titleGradient.Rotation = offset
                wait(0.03)
            end
        end)
        ...
        function windowTypes:Tab(name)
            ...
            local tabToggle = utility.create("TextButton", {
                ZIndex = 3,
                BackgroundColor3 = toggled and Color3.fromRGB(45, 45, 45) or Color3.fromRGB(32, 32, 32),
                BorderSizePixel = 0,
                FontSize = Enum.FontSize.Size14,
                TextSize = 13,
                TextColor3 = toggled and Color3.fromRGB(255, 255, 255) or Color3.fromRGB(160, 160, 160),
                Text = name,
            ...
            tabToggle.Size = UDim2.new(0, tabToggle.TextBounds.X + 32, 1, 0)
            ...
            local function openTab()
                ...
                for _, obj in next, tabTogglesHolder:GetChildren() do
                    if obj:IsA("TextButton") then
                        ...
                        obj.BackgroundColor3 = Color3.fromRGB(32, 32, 32)
                    end
                end

                -- Highlight selected tab
                tabToggle.Font = Enum.Font.GothamMedium
                tabToggle.TextColor3 = Color3.fromRGB(255, 255, 255)
                tabToggle.BackgroundColor3 = Color3.fromRGB(45, 45, 45)
            ...
            function tabTypes:Section(opts)
                ...
                sectionContentList:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
                    sectionHolder.Size = UDim2.new(1, 0, 0, sectionContentList.AbsoluteContentSize.Y + 44)
                end)
